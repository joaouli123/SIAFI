...
export const SECTIONS: LegalSection[] = [
  {
    ...
    conteudo: `A Lidera Tecnologia e Gestão Ltda (doravante "Lidera"), pessoa jurídica de direito privado, inscrita no CNPJ sob o nº [PREENCHER: CNPJ DA EMPRESA], com sede em [PREENCHER: ENDEREÇO COMPLETO], Cuiabá, Estado do Mato Grosso, é a responsável pela operação do SIAFI — Sistema de Agilidade Financeira, acessível em https://2wm.siafi.app.br.`,
  },
  {
...
• Portal de suporte: https://2wm.siafi.app.br/portal/suporte`,
  },
]
